...
export const FirstSection = () => {
  return (
    <section id='about' className='max-w-7xl container mx-auto px-10 mb-20 flex flex-col md:px-15 md:flex-row md:align-middle place-items-center justify-center'>
